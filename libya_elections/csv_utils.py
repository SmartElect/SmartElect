# Code used in this module was taken from the python documentation and
...
try:
    # Python 2
    from cStringIO import StringIO as BinaryIO
except ImportError:
    # Python 3
...
class UnicodeDictReader:
    ...
    @property
    def fieldnames(self):
        return [s.decode("utf-8") for s in self.reader.fieldnames]

    def next(self):
        row = self.reader.next()
        return {k.decode("utf-8"): v.decode("utf-8") for k, v in row.iteritems()}
